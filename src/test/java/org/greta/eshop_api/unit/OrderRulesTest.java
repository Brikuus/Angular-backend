...
class OrderRulesTest {
    ...
    void setup() {
        ...
        tooLargeItem = new OrderItemRequestDTO(210L, 15);
    }
    ...
    void shouldThrowIfAllProductsInactive() {
        ...
        Exception ex = assertThrows(RuntimeException.class,
                () -> OrderRules.validateProducts2(products));
    ...
    void shouldPassIfAtLeastOneProductIsActive() {
        ...
        assertDoesNotThrow(() -> OrderRules.validateProducts2(products));
    }
    ...
    void shouldThrowIfQuantityExceedsStock() {
        Exception ex = assertThrows(RuntimeException.class,
                () -> OrderRules.validateStock2(tooLargeItem, activeProduct));
    ...
    void shouldPassIfQuantityWithinStock() {
        assertDoesNotThrow(() -> OrderRules.validateStock2(validItem, activeProduct));
    }
    ...
    void shouldThrowIfTotalExceedsLimit() {
        ...
        Exception ex = assertThrows(RuntimeException.class,
                () -> OrderRules.validateTotal2(total));
    ...
    void shouldPassIfTotalUnderLimit() {
        ...
        assertDoesNotThrow(() -> OrderRules.validateTotal2(total));
    }
    ...
    void shouldThrowIfStatusInvalid() {
        ...
        Exception ex = assertThrows(RuntimeException.class,
                () -> OrderRules.validateOrderStatus2(status));
    ...
    void shouldPassIfStatusValid() {
        ...
        assertDoesNotThrow(() -> OrderRules.validateOrderStatus2(status));
    }
}
